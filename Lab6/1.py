#Напишит программу, используя минимум по 5 функции для работы
# с кортежем(tuple) имножествами(Set).В виде данных пусть каждый студент
# предложит своt резюме. И будет работать с этими данными.

#Кортежи

#Имя, возраст, язык программирования, место учебы, Специальность, опыт работы
student = ['Malika', 18, 'Python', 'Satbayev University', 'Computer Science', 3]
...
student_choose = student_tuple[0:4]
print(student_choose)
