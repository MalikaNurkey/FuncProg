#Напишите  программу,  используя минимум 5 функции для  работы  со списком.
# В виде списка пусть каждый студент предложит свое резюме. И будет работать с этим списком.
